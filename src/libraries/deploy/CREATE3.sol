...
/// (https://github.com/transmissions11/solmate/blob/main/src/utils/CREATE3.sol) @author Modified
/// from 0xSequence (https://github.com/0xSequence/create3/blob/master/contracts/Create3.sol)
/// @dev Bumped to Solidity 0.8.33 for Osaka EVM compatibility
library CREATE3 {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                        CUSTOM ERRORS                       */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
